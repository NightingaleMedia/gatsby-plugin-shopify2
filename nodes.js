...
exports.ShopPolicyNode = exports.ProductVariantNode = exports.ProductOptionNode = exports.ProductNode = exports.ProductTypeNode = exports.CommentNode = exports.CollectionNode = exports.BlogNode = exports.ArticleNode = undefined;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 4;
              return downloadImageAndCreateFileNode({ id: node.image.id, url: node.image.src && node.image.src.split("?")[0] }, imageArgs);
...
var ProductTypeNode = exports.ProductTypeNode = function ProductTypeNode(imageArgs) {
                  ...
                  return _regenerator2.default.wrap(function _callee4$(_context4) {
                    while (1) {
                      switch (_context4.prev = _context4.next) {
                        case 0:
                          _context4.next = 2;
                          return downloadImageAndCreateFileNode({ id: edge.node.id, url: edge.node.originalSrc && edge.node.originalSrc.split("?")[0] }, imageArgs);
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 3;
              return downloadImageAndCreateFileNode({ id: node.image.id, url: node.image.originalSrc && node.image.originalSrc.split("?")[0] }, imageArgs);
