...
var sourceNodes = exports.sourceNodes = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6(_ref2, _ref3) {
    var _ref2$boundActionCrea = _ref2.boundActionCreators,
        ...
        createNodeId = _ref2$boundActionCrea.createNodeId,
        store = _ref2.store,
        cache = _ref2.cache;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            imageArgs = { createNode: createNode, createNodeId: createNodeId, touchNode: touchNode, store: store, cache: cache

              // Arguments used for node creation.
            };
            args = { client: client, createNode: createNode, createNodeId: createNodeId, formatMsg: formatMsg, verbose: verbose, imageArgs: imageArgs
            ...
            }()), createNodes('blogs', _queries.BLOGS_QUERY, _nodes.BlogNode, args), createNodes('collections', _queries.COLLECTIONS_QUERY, _nodes.CollectionNode, args), createNodes('productTypes', _queries.PRODUCT_TYPES_QUERY, _nodes.ProductTypeNode, args), createNodes('products', _queries.PRODUCTS_QUERY, _nodes.ProductNode, args, function () {
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 4:
            ...
            (0, _entries2.default)(policies).filter(function (_ref16) {
              var _ref17 = (0, _slicedToArray3.default)(_ref16, 2),
                  _ = _ref17[0],
                  policy = _ref17[1];

              return Boolean(policy);
            }).forEach((0, _fp.pipe)(function (_ref18) {
